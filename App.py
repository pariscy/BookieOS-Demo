...
st.markdown(
    """
    <style>
    div[data-testid="stHorizontalBlock"]:has(div[data-testid="stColumn"]) { align-items: stretch; }
    ...
    div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:last-child [data-testid="stTextInput"] input {
    ...
    div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:last-child [data-testid="stTextInput"] label {
        color: #F1C400 !important;
        font-weight: 800 !important;
    }
    div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]::-webkit-scrollbar { width: 8px; }
    div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]::-webkit-scrollbar-thumb {
        background: rgba(241,196,0,.25); border-radius: 20px;
    }
    @media (max-width: 900px) {
        div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"] { height:auto; overflow:visible; }
        div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:last-child { border-left:none; padding-left:0; }
    }
    </style>
    """,
...
def contains_any(text, words): return any(word in text for word in words)
...
with agent_column:
    ...
    weekly_request=st.text_input("Γράψε περίοδο / αίτημα",value="Βρες τους καλύτερους αγώνες της επόμενης εβδομάδας για marketing.",key="weekly_request_input")
    ...
    research_task=st.text_input("Γράψε τι θέλεις να ερευνήσει",key="research_task_input")
    if st.button("🔬 RUN RESEARCH",type="primary",use_container_width=True):
        if research_task.strip():
            try:
                with st.spinner("Live web research..."): result=run_research_agent(client,research_task)
                set_main_result("🔬 Research Agent 09",result)
    ...
    article_brief=st.text_input("Γράψε τι θέλεις να περιλαμβάνει το άρθρο",placeholder="π.χ. Άρθρο για το αποψινό Champions League...",key="article_brief_input")
    ...
    brainstorm_challenge=st.text_input("Γράψε για ποιο θέμα θέλεις ιδέες",placeholder="π.χ. Ιδέες για καμπάνια Champions League...",key="brainstorm_challenge_input")
