...
def detect_agent(user_prompt):
    ...
    if contains_any(text, [
        "deep research", "research agent", "κάνε έρευνα", "κανε ερευνα",
...
Έλεγξε current form, παίκτες, τραυματισμούς/τιμωρίες και πρόσφατα στατιστικά.
Βαθμολόγησε STRONG, REASONABLE ή WEAK.
Μην δώσεις odds ή επινοήσεις BookieCo market availability.
...
main_column, agent_column = st.columns([4, 1], gap="large")
